...
// Use working QR API (replaces deprecated Google Charts)
$qr_url = "https://api.qrserver.com/v1/create-qr-code/?size=250x250&data=" . $encoded_data;
?>
...
<head>
    ...
    <style>
        ...
        @media print {
            ...
            .qr-container { background: white; box-shadow: none; }
            h2 { color: black; }
...
<body>
    <div class="qr-container">
        ...
        <div>
            ...
            <a href="my_tickets.php" class="btn">← Back</a>
        </div>
    </div>
</body>
</html>